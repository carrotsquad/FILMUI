...
public class GetUserInfo {
    ...
    public static ArrayList<SingleHotMovie> getUserInfo(String strUrlPath, String username) throws IOException {
        ...
        if(response == HttpURLConnection.HTTP_OK) {
            ...
            return dealResponseResult_get(inptStream);                     //处理服务器的响应结果
        }
     ...
     */
    public static ArrayList dealResponseResult_get(InputStream inputStream) throws IOException {
        ...
        for(; j<resultData_2.length; j++){
            ...
            if(i==9){
                i=1;
                singleHotMovieList.add(new SingleHotMovie(biaoji[1],biaoji[0],biaoji[2],biaoji[3],biaoji[4],biaoji[5],biaoji[6]));
            }
        }
