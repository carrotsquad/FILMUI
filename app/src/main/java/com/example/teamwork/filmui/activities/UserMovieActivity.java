...
public class UserMovieActivity extends AppCompatActivity {
    ...
    private void initList() throws IOException {
        ...
        ArrayList<SingleHotMovie> singleHotMovieArrayList= new ArrayList<>();

        Thread thread=new Thread(){
            @Override
            public void run() {
                try {
                    singleHotMovieArrayList.addAll(getUserInfo(url,name));
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
...
//        strings.add("26810318");
        ...
        initRecycler(singleHotMovieArrayList);
    }
     ...
     * 初始化RecyclerView
     */
    private void initRecycler(ArrayList<SingleHotMovie> singleHotMovieArrayList) throws IOException {
        ...
        Log.e("用户电影列表大小",Integer.toString(singleHotMovieArrayList.size()));
        hotMovieAdapter = new HotMovieAdapter(UserMovieActivity.this , singleHotMovieArrayList, info);
