...
//          //第二层解析
            ...
            for(int i = 0;i<directors.length();i++){
                ...
                singleCasts.add(new SingleCast(name,avatar,id,summary,akas.toString(),countries.toString(),wish_count,collect_count));
            }
            ...
            for(int i = 0;i<casts.length();i++){
                ...
                String avatar = avatars.optString("small");
                singleCasts.add(new SingleCast(name,avatar,id,summary,aka.toString(),countries.toString(),wish_count,collect_count));
            }
